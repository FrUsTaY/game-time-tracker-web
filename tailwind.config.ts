...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        comic: "4px 4px 0 0 hsl(var(--foreground))",
        "comic-sm": "2px 2px 0 0 hsl(var(--foreground))",
        "comic-magenta": "4px 4px 0 0 hsl(335 100% 55%)",
        "comic-cyan": "4px 4px 0 0 hsl(178 90% 45%)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        glitch: {
          ...
          "20%": { transform: "translate(-2px, 1px) skewX(-4deg)" },
